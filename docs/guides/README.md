...
How-to guides and tutorials for common development tasks.

| Document | Description |
|----------|-------------|
| [Getting Started](getting-started.md) | Prerequisites, setup, project overview |
...
| [Performance](performance.md) | Lighthouse targets, RSC, images, fonts |
